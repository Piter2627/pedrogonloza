const contributors = {
  ...
  martinschierle: {
    ...
    org: {
      name: 'Google',
      unit: 'Technical Solutions',
    },
    country: 'DE',
    twitter: 'martinschierle',
  ...
  linahansson: {
    ...
    description: {
      en:
        'Lina is a Conversion Specialist at Google, focused on mobile CRO and site speed.',
    },
  },
  bojanpavic: {
    name: {
  ...
  hbatra: {
    ...
    org: {
      name: 'Google',
      unit: 'Developer Marketing',
    },
    country: 'US',
    twitter: 'harleenkbatra',
    description: {
  ...
  sfluin: {
    ...
    org: {
      name: 'Google',
      unit: 'Developer Advocate for Angular',
    },
    country: 'US',
...
module.exports = processedContributors;
